        ...
        >
          <div className="lcl--content">
            {socialsData.linkedIn && (
              <a
                href="https://www.linkedin.com/in/nitish-kumar-50a564205/"
                target="_blank"
                rel="noreferrer"
              >
                <FaLinkedin
            ...
            {socialsData.twitter && (
              <a
                href="https://twitter.com/Nitishk60487582"
                target="_blank"
                rel="noreferrer"
              >
                <FaTwitter
            ...
            {socialsData.youtube && (
              <a
                href="https://www.youtube.com/channel/UCBO7mVSTXJgKpniFYo57ncQ"
                target="_blank"
                rel="noreferrer"
              >
                <FaYoutube
            ...
            {socialsData.medium && (
              <a
                href="https://medium.com/@nitishfea120784"
                target="_blank"
                rel="noreferrer"
              >
                <FaMedium
            ...
            >
              <div style={{ marginBottom: "30px", marginRight: "2em" }}>
                {headerData.resumePdf && (
                  <a
                    href="https://drive.google.com/file/d/1V-e7yjfJOLPT_8Ju3K605A5rLX-CVKAh/view?usp=sharing"
                    download="resume"
                    target="_blank"
                    rel="noreferrer"
